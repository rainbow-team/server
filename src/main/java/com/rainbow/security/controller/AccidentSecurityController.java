...
/**
 * Created by 13260 on 2019/5/11. 事故事件管理
 */
@RestController
...
public class AccidentSecurityController {
    ...
    @SystemLog(description = "导出事故事件信息")
    public void exportAccidentSecurity(@RequestParam(value = "depart", required = false) String depart,
            ...
            @RequestParam(value = "natureIds", required = false) String natureIds, HttpServletResponse response) {
     ...
     * @return
     */
    @SystemLog(description = "导入事故事件信息")
    @RequestMapping(value = "/importData", method = RequestMethod.POST)
    @ResponseBody
    public ResponseBo importData(HttpServletRequest request) {

        return accidentSecurityService.importData(request);
    }
}
